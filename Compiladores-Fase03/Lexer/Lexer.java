...
public class Lexer {
  ...
  static {
    ...
    keywordsTable.put( "Boolean", Symbol.LITERALBOOLEAN );
    ...
    keywordsTable.put( "Int", Symbol.LITERALINT);
    keywordsTable.put( "String", Symbol.LITERALSTRING);
    keywordsTable.put( "return", Symbol.RETURN );
    keywordsTable.put( "while", Symbol.WHILE );
    keywordsTable.put( "invalido", Symbol.INVALID );
  }
    ...
    if ( ch == '\0') {
      ...
      if ( input[tokenPos] == '/' && input[tokenPos + 1] == '/' ) {
        ...
        if(ch == '"') {
          ...
          if (flag == 1) {
            error.signal("O identificador contém um número em seu nome");
  ...
  public Symbol get_keywords(String palavra) {
